...
function getTooltipLabel(el) {
  ...
  if (el.id === "paLogoutBtn") return "Logout";
...
function refreshSidebarTooltips(sidebar) {
  ...
  sidebar.querySelectorAll(
    ".pa-logo-link, .pa-nav-item, .pa-nav-subitem, .pa-logout"
  ).forEach((el) => {
...
function applyUserDisplay(user) {
  ...
  document.querySelectorAll(
    "#paUserMenuAvatar, #paUserMenu .pa-avatar, .pa-header-user .pa-avatar, #paUserDropdownAvatar .pa-avatar"
  ).forEach((el) => {
