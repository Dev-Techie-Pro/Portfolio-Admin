// client/utils/password-toggle.ts
var TOGGLE_SELECTOR = ".pa-password-toggle, .pa-auth-pass-toggle";
var WRAP_SELECTOR = ".pa-password-wrap, .pa-auth-input-wrap";
var BOUND_ATTR = "data-pa-pw-toggle-bound";
...
function resolvePasswordInput(ref) {
  ...
  if (typeof ref.querySelector === "function") {
    return ref.querySelector('input[type="password"]') || ref.querySelector(`${WRAP_SELECTOR} input[type="password"]`);
  }
  return null;
}
...
function updatePasswordToggleUi(input, toggleBtn) {
  ...
  toggleBtn.setAttribute(
    "aria-label",
    isHidden ? valueLabel ? "Show value" : "Show password" : valueLabel ? "Hide value" : "Hide password"
  );
...
function setupPasswordToggle(inputRef, toggleBtnId) {
