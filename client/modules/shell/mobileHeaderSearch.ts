...
export function isMobileHeaderSearchOpen() {
  return headerTop?.classList.contains('pa-header-top--search-open') ?? false;
}

export function closeMobileHeaderSearch() {
  if (!headerTop) return;
...
export function openMobileHeaderSearch() {
...
export function initMobileHeaderSearch() {
