...
export class BlogCategoriesModule extends CrudCardModule {
  constructor() {
    super({
  ...
  matchesSearch(record, query) {
    ...
    return record.key.toLowerCase().includes(q)
  ...
  navigateToBlogPosts(categoryKey) {
    try { sessionStorage.setItem('pa_blog_cat_filter', String(categoryKey)); } catch { /* ignore */ }
  ...
  bindEvents() {
    ...
    this.on($id('blogCatAddKey'), 'input', () => { this.addKeyTouched = true; });
