...
export function buildLogoIconSvg(accent = DEFAULT_ACCENT, bg = DEFAULT_BG) {
...
export function updateFavicon(accent, bg) {
...
export function updateFaviconFromAppearance(appearance) {
