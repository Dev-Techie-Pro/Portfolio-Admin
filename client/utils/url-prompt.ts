...
/**
 * Show a styled URL prompt modal.
 * @param {object} [options]
 * @param {string} [options.defaultValue]
 * @param {string} [options.title]
 * @param {string} [options.subtitle]
 * @param {string} [options.confirmLabel]
 * @returns {Promise<string|null>} URL string, empty string to remove link, or null if cancelled.
 */
export function promptUrl(options = {}) {
  ensureModal();
